...
def cluster_GMM(num_clusters, word_vectors):
    ...
    print("Clustering Done..." + str(time.time()-start) + "seconds")
...
if __name__ == '__main__':
    ...
    print("Creating Document Vectors...:"+str(temp_time)+"seconds.")
    ...
    for review in train["news"]:
        ...
        counter+=1
        if counter % 1000 == 0:
            print("Train News Covered : "+str(counter))
    ...
    for review in test["news"]:
        ...
        counter+=1
        if counter % 1000 == 0:
            print("Test News Covered : "+str(counter))
    ...
    print("Average min: " + str(min_no))
    print("Average max: " + str(max_no))
    ...
    print("SDV created and dumped: "+str(endtime)+"seconds.")
    ...
    for score in scores:
        ...
        print("Best value for "+str(score)+":\n")
        print(str(clf.best_score_))
        Y_true, Y_pred  = test["class"], clf.predict(gwbowv_test)
        print("Report")
        print(str(classification_report(Y_true, Y_pred, digits=6)))
        print("Accuracy: " + str(clf.score(gwbowv_test,test["class"])))
        print("Time taken:"+str(time.time() - strt)+"\n")
    endtime = time.time()
    print("Total time taken: "+str(endtime-start)+"seconds.")
